								...
								<Form>
									<Row className="justify-content-between align-items-center">
										<Col md={4} className="mb-md-0 mb-1">
											...
											<Input type="text" id={`animation-item-name-${i}`} placeholder="Venite University Admin Template" />
										</Col>
										...
										<Col md={2} className="mb-md-0 mb-1">
											...
											<input readOnly disabled value="$32" placeholder="$32" id={`animation-price-${i}`} className="form-control-plaintext" />
										</Col>
										<Col md={2}>
