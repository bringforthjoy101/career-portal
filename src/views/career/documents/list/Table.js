...
// ** Store & Actions
import { getAllAdmins, getFilteredData } from '../store/action'
  ...
  return (
    <div className='invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75'>
      <Row>
        ...
        <Col xl='12' className='d-flex align-items-sm-center justify-content-xl-end justify-content-end align-items-center flex-xl-nowrap flex-wrap flex-sm-row flex-column pe-xl-1 p-0 mt-xl-0'>
          <Button className='ms-2' color='primary' onClick={handleModal}>
            <Plus size={15} />
            <span className='align-middle ms-50'>Create Admin</span>
          </Button>
        </Col>
      </Row>
    </div>
...
const DataTableWithButtons = () => {
  ...
  const filteredData = store?.allData?.filter(
    item => (item?.email?.toLowerCase() || item?.names?.toLowerCase())
  )
      ...
      <Card>
        ...
        <CardBody>
          <Row>
            ...
            <Col md='4'>
              <Label className='me-1' for='select'>Select Role: </Label>
              <Select
                isClearable={false}
            ...
            <Col md='4'>
              <Label className='me-1' for='select'>Select Status: </Label>
              <Select
                isClearable={false}
                className='react-select'
                classNamePrefix='select'
