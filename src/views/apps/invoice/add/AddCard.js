...
const AddCard = () => {
	...
	const note = 'It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!'
	...
	return (
		<Fragment>
						...
						<div className="invoice-number-date mt-md-0 mt-2">
							<div className="d-flex align-items-center justify-content-md-end mb-1">
								...
								<InputGroup className="input-group-merge invoice-edit-input-group disabled">
									...
									<Input type="number" className="invoice-edit-input" value={invoiceNumber || 3171} placeholder="53634" disabled />
								</InputGroup>
							</div>
							<div className="d-flex align-items-center mb-1">
								<span className="title">Date:</span>
								<Flatpickr value={picker} onChange={(date) => setPicker(date)} className="form-control invoice-edit-input date-picker" />
							</div>
			...
			<Sidebar size="lg" open={open} title="Add Payment" headerClassName="mb-1" contentClassName="p-0" toggleSidebar={toggleSidebar}>
				<Form>
					<div className="mb-2">
					...
					<div className="mb-2">
						...
						<Select theme={selectThemeColors} className="react-select" classNamePrefix="select" options={countryOptions} isClearable={false} />
					</div>
					<div className="mb-2">
