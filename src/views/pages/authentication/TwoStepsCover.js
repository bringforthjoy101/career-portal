...
const TwoStepsCover = () => {
	...
	const illustration = skin === 'dark' ? 'two-steps-verification-illustration-dark.svg' : 'two-steps-verification-illustration.svg',
			...
			<Row className="auth-inner m-0">
				...
				<Col className="d-flex align-items-center auth-bg px-2 p-lg-5" lg="4" sm="12">
					<Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
						...
						<CardText className="mb-75">We sent a verification code to your mobile. Enter the code from the mobile in the field below.</CardText>
